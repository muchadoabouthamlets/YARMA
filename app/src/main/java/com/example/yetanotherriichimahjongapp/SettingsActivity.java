...
public class SettingsActivity extends AppCompatPreferenceActivity {
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class RulesPreferenceFragment extends PreferenceFragment {
        @Override
    ...
    public static class UIPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("list_ui_orientation"));
            bindPreferenceSummaryToValue(findPreference("text_ui_display_name"));
